...
if an == 1:
    for n in range(no_of_dataset):
        ...
        Global_Vars.Target = Target
        Npop = 10
        Chlen = 4  # activation of OMCN_LSTM, optimizer of OMCN_LSTM, epoch of OMCN_LSTM, leaning rate of OMCN_LSTM
...
if an == 1:
    ...
    for n in range(no_of_dataset):
        ...
        np.save('Eval_all.npy', np.asarray(Eval_all))  # Save the Eval all
